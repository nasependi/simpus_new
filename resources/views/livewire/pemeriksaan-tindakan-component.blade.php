<div class="p-6">
    <flux:card class="shadow-lg rounded-lg">
        <div class="flex justify-between mb-4">
            <flux:heading size="xl">Data Pemeriksaan Tindakan</flux:heading>
            <div class="flex gap-4 items-center">
                <flux:input wire:model.live="search" placeholder="Cari tindakan..." icon="magnifying-glass" />
        ...
        <flux:table :paginate="$data">
            <flux:table.columns>
                <flux:table.column>Nama Tindakan</flux:table.column>
        ...
        {{-- Modal Tambah/Edit --}}
        <flux:modal name="tindakanModal" class="space-y-4 md:w-[30rem]">
            <flux:heading class="text-lg font-semibold">
                {{ $editId ? 'Edit' : 'Tambah' }} Pemeriksaan Tindakan
            </flux:heading>

            <flux:input wire:model="nama" label="Nama Tindakan" required />
        ...
        <flux:modal name="delete-tindakan" class="min-w-[22rem]">
            <div class="space-y-6">
                <div>
