...
<div class="w-full">
    ...
    <div class="backdrop-blur-xl bg-white/70 dark:bg-neutral-900/70 rounded-3xl shadow-2xl p-8 md:p-10 border border-white/20 dark:border-neutral-700/30">
        ...
        <form wire:submit="login" class="space-y-5">
            ...
            <div class="flex justify-end">
                <a href="{{ route('password.request') }}" wire:navigate class="text-sm text-neutral-600 dark:text-neutral-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                    Forgot password?
                </a>
            </div>
            @endif
            ...
            <div class="flex items-center">
                <input
                    ...
                    id="remember"
                    type="checkbox"
                    class="w-4 h-4 text-blue-600 bg-neutral-100 dark:bg-neutral-800 border-neutral-300 dark:border-neutral-600 rounded focus:ring-blue-500 dark:focus:ring-blue-400 focus:ring-2" />
    ...
    <div class="mt-6 text-center text-sm text-neutral-600 dark:text-neutral-400">
        Belum punya akun?
        <a href="{{ route('register') }}" wire:navigate class="font-semibold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors">
            Daftar sekarang
        </a>
    </div>
    @endif
