<div class="p-6">
    <flux:card class="shadow-lg rounded-lg">
        <div class="flex justify-between mb-4">
            <flux:heading size="xl">Data Cara Pembayaran</flux:heading>
            <div class="flex gap-4 items-center">
                <flux:input wire:model.live="search" placeholder="Cari cara pembayaran..." icon="magnifying-glass" size="md" />
        ...
        {{-- Modal Tambah/Edit --}}
        <flux:modal name="caraPembayaranModal" class="space-y-4 md:w-[50rem]">
            <flux:heading class="text-lg font-semibold">
                {{ $editId ? 'Edit' : 'Tambah' }} Cara Pembayaran
            </flux:heading>
        ...
        <flux:modal name="delete-caraPembayaran" class="min-w-[22rem]">
            <div class="space-y-6">
                <div>
                    <flux:heading size="lg">Hapus Data Cara Pembayaran?</flux:heading>
